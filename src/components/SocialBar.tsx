...
export const SocialBar: React.FC<SocialBarProps> = ({ lang }) => {
  return (
    <section className="flex items-center justify-between p-4 bg-background border-b border-line">
      <div className="flex flex-wrap items-center gap-2">
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-md border border-line bg-surface px-3 py-1.5 text-xs font-medium text-muted-foreground transition hover:bg-surface-hover hover:text-foreground hover:border-line-strong hover:-translate-y-0.5"
        >
